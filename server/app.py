...
def get_weather (city):
    ...
    url = "http://api.weatherbit.io/v2.0/current?city=" + city +"&key=" + keys["WEATHER_API_KEY"]
    url_daily = "http://api.weatherbit.io/v2.0/forecast/daily?city=" + city +"&days=1&key=" + keys["WEATHER_API_KEY"]
